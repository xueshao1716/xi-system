...
$files = Get-ChildItem "D:\xi-system\chat4\*.png" | Sort-Object Name
$count = 0
foreach ($f in $files) {
...
[System.IO.File]::WriteAllText("D:\xi-system\chat4\all.txt", $allSb.ToString(), [System.Text.Encoding]::UTF8)
