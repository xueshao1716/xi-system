...
$files = Get-ChildItem "D:\xi-system\chat2\*.png" | Sort-Object Name
foreach ($f in $files) {
...
[System.IO.File]::WriteAllText("D:\xi-system\chat2\all.txt", $allSb.ToString(), [System.Text.Encoding]::UTF8)
