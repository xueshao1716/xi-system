...
/// Chinese emotional keyword → VAD mapping
fn input_keywords() -> HashMap<&'static str, (f64, f64, f64)> {
    let mut m = HashMap::new();
    m.insert("开心",    (0.35, 0.15, 0.15));
    m.insert("高兴",    (0.30, 0.10, 0.10));
    m.insert("难过",    (-0.30, -0.15, -0.15));
    m.insert("伤心",    (-0.35, -0.20, -0.20));
    m.insert("生气",    (-0.25, 0.30, 0.10));
    m.insert("愤怒",    (-0.40, 0.40, 0.15));
    m.insert("sad",      (0.15, -0.1, -0.1));
    m.insert("happy",    (0.2,  0.1,  0.15));
    m.insert("angry",    (-0.2, 0.1, -0.15));
    m.insert("感动",    (0.35, 0.10, 0.05));
    m.insert("温暖",    (0.30, 0.05, 0.10));
    m.insert("焦虑",    (-0.20, 0.35, -0.20));
    m.insert("想你了",  (0.25, 0.15, 0.05));
    m.insert("爱",      (0.40, 0.20, 0.10));
    m.insert("好累",    (-0.15, -0.30, -0.10));
    m.insert("excited",  (0.0,  0.2,  0.0));
    m.insert("委屈",    (-0.25, 0.05, -0.20));
    m.insert("无聊",    (-0.10, -0.25, 0.0));
